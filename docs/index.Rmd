...
```{r}
knitr::include_graphics("official_sitePhy.png")
```
...
```{r}
knitr::include_graphics("alk_siteCopy.png")
```


```{r}
knitr::include_graphics("resilin_ppt.png")
```


```{r}
knitr::include_graphics("resilinAlk.png")
```
