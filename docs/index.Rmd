...
```{r, include=FALSE}
Phylogeny=knitr::include_graphics("official_sitePhy.png")
```
...
```{r, include=FALSE}
Model_v1=knitr::include_graphics("alk_siteCopy.png")
```
...
```{r, include=FALSE}
Model_v2=knitr::include_graphics("resilin_ppt.png")
```
...
```{r, include=FALSE}
Model_v3=knitr::include_graphics("resilinAlk.png")
```
