...
Data visualization is critical for effective communication of scientific data, yet it is an area that many scientists struggle with. My aim with this project is to assist scientists, especially biologists, with statistics and data visualization. Below are some examples of figures that I have produced.  <br>
<br>
...
![ ](~/Desktop/rDirectory/rMarkdown/datavis_website/official_sitePhy.png)
...
![ ](~/Desktop/rDirectory/rMarkdown/datavis_website/alk_siteCopy.png)



![](~/Desktop/rDirectory/rMarkdown/datavis_website/resilin_ppt.png)


![](~/Desktop/rDirectory/rMarkdown/datavis_website/resilinAlk.png)
